...
#define InitializeObjectAttributes( p, n, a, r, s ) {   \
    (p)->Length = sizeof( _MemLib::NtDll::OBJECT_ATTRIBUTES );          \
    (p)->RootDirectory = r;                             \
    (p)->Attributes = a;                                \
    (p)->ObjectName = n;                                \
...
typedef void(NTAPI tRtlInitUnicodeString)(_Out_ PUNICODE_STRING DestinationString, _In_opt_z_ PCWSTR SourceString);
...
typedef NTSTATUS(NTAPI tLdrpLoadDll)(
    PUNICODE_STRING DllName, LDR_UNKSTRUCT* DllPathInited, ULONG Flags, LDR_DATA_TABLE_ENTRY** DllEntry);

typedef NTSTATUS(NTAPI tLdrpLoadDllInternal)(PUNICODE_STRING FullPath, LDR_UNKSTRUCT* DllPathInited, ULONG Flags, ULONG LdrFlags, PLDR_DATA_TABLE_ENTRY LdrEntry, PLDR_DATA_TABLE_ENTRY LdrEntry2, PLDR_DATA_TABLE_ENTRY* DllEntry, NTSTATUS* pStatus, ULONG Zero);
